...
class VideoCache:
    def __init__(self, root: Path, video_hash: str) -> None:
        ...
        # What the agent's transcription calls have taught us. Beside the index
        # rather than in it: the index is what processing the video produced,
        # this is what a later pass learned.
        self.transcripts_path = self.root / "transcripts.jsonl"
